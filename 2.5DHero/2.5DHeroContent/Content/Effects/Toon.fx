...
technique Toon
{
	...
	pass Pass1
	{
		VertexShader = compile vs_2_0_level_9_1 OutlineVertexShader();
		PixelShader = compile ps_2_0_level_9_1 OutlinePixelShader();
		CullMode = CW;
	}
	...
	pass Pass2
	{
		VertexShader = compile vs_2_0_level_9_1 CelVertexShader();
		PixelShader = compile ps_2_0_level_9_1 CelPixelShader();
		CullMode = CCW;
	}
}
